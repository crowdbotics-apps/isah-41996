"""
Django settings for isah_41996 project.
...
WSGI_APPLICATION = 'isah_41996.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "isah_41996 API",
    "DESCRIPTION": "API documentation for isah_41996 App",
    "VERSION": "v1",
}
